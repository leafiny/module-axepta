...
/**
 * Class Axepta_Page_Complete_Redirect
 */
class Axepta_Page_Complete_Redirect extends Core_Page
{
    /**
     * Redirect the customer when returning to the website
     * This is due to the strict cookie policy. We have to init the session.
     *
     * @return void
     */
    public function action(): void
    {
        ...
        if ($result === Axepta_Helper_Axepta::PAYMENT_RESULT_CANCEL) {
        ...
        if ($result === Axepta_Helper_Axepta::PAYMENT_RESULT_FAILURE) {
            $this->setErrorMessage(
        ...
        if ($result === Axepta_Helper_Axepta::PAYMENT_RESULT_SUCCESS) {
            $this->redirect(
